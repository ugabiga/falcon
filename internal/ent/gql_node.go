...
// IsNode implements the Node interface check for GQLGen.
func (n *TaskHistory) IsNode() {}

// IsNode implements the Node interface check for GQLGen.
func (n *TradingAccount) IsNode() {}
...
func (c *Client) noder(ctx context.Context, table string, id int) (Noder, error) {
	...
	case taskhistory.Table:
		...
		query, err := query.CollectFields(ctx, "TaskHistory")
		if err != nil {
			return nil, err
		}
		n, err := query.Only(ctx)
		...
		return n, nil
	case tradingaccount.Table:
		query := c.TradingAccount.Query().
			Where(tradingaccount.ID(id))
		query, err := query.CollectFields(ctx, "TradingAccount")
		if err != nil {
			return nil, err
		}
		n, err := query.Only(ctx)
