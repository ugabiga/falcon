...
func (uq *UserQuery) QueryAuthentications() *AuthenticationQuery {
...
func (uq *UserQuery) WithAuthentications(opts ...func(*AuthenticationQuery)) *UserQuery {
	query := (&AuthenticationClient{config: uq.config}).Query()
...
func (uq *UserQuery) sqlAll(ctx context.Context, hooks ...queryHook) ([]*User, error) {
	...
	if query := uq.withAuthentications; query != nil {
