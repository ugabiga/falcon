...
type QueryResolver interface {
	...
	Tasks(ctx context.Context, tradingAccountID *string) ([]*Task, error)
	TradingAccounts(ctx context.Context) ([]*TradingAccount, error)
	TradingAccountsWithTasks(ctx context.Context, id *string) (*TradingAccountWithTasks, error)
}
...
func (ec *executionContext) field_Query_tradingAccountsWithTasks_args(ctx context.Context, rawArgs map[string]interface{}) (map[string]interface{}, error) {
	var err error
	args := map[string]interface{}{}
	var arg0 *string
	if tmp, ok := rawArgs["id"]; ok {
...
func (ec *executionContext) _Mutation_createTradingAccount(ctx context.Context, field graphql.CollectedField) (ret graphql.Marshaler) {
	...
	resTmp, err := ec.ResolverMiddleware(ctx, func(rctx context.Context) (interface{}, error) {
		ctx = rctx // use context from middleware stack in children
		return ec.resolvers.Mutation().CreateTradingAccount(rctx, fc.Args["exchange"].(string), fc.Args["currency"].(string), fc.Args["identifier"].(string), fc.Args["credential"].(string))
	})
	if err != nil {
		ec.Error(ctx, err)
		return graphql.Null
...
func (ec *executionContext) _Query_tasks(ctx context.Context, field graphql.CollectedField) (ret graphql.Marshaler) {
	...
	resTmp, err := ec.ResolverMiddleware(ctx, func(rctx context.Context) (interface{}, error) {
		ctx = rctx // use context from middleware stack in children
		return ec.resolvers.Query().Tasks(rctx, fc.Args["tradingAccountId"].(*string))
	})
	if err != nil {
		ec.Error(ctx, err)
		return graphql.Null
...
func (ec *executionContext) _Query_tradingAccountsWithTasks(ctx context.Context, field graphql.CollectedField) (ret graphql.Marshaler) {
	fc, err := ec.fieldContext_Query_tradingAccountsWithTasks(ctx, field)
	if err != nil {
		return graphql.Null
	}
	ctx = graphql.WithFieldContext(ctx, fc)
	...
	resTmp, err := ec.ResolverMiddleware(ctx, func(rctx context.Context) (interface{}, error) {
		ctx = rctx // use context from middleware stack in children
		return ec.resolvers.Query().TradingAccountsWithTasks(rctx, fc.Args["id"].(*string))
	})
	if err != nil {
		ec.Error(ctx, err)
		return graphql.Null
	...
	res := resTmp.(*TradingAccountWithTasks)
	fc.Result = res
	return ec.marshalNTradingAccountWithTasks2ᚖgithubᚗcomᚋugabigaᚋfalconᚋinternalᚋgraphᚋgeneratedᚐTradingAccountWithTasks(ctx, field.Selections, res)
}

func (ec *executionContext) fieldContext_Query_tradingAccountsWithTasks(ctx context.Context, field graphql.CollectedField) (fc *graphql.FieldContext, err error) {
	fc = &graphql.FieldContext{
		Object:     "Query",
		Field:      field,
		IsMethod:   true,
		...
		Child: func(ctx context.Context, field graphql.CollectedField) (*graphql.FieldContext, error) {
			...
			case "selectedTradingAccount":
				return ec.fieldContext_TradingAccountWithTasks_selectedTradingAccount(ctx, field)
			case "tradingAccounts":
				return ec.fieldContext_TradingAccountWithTasks_tradingAccounts(ctx, field)
			}
			return nil, fmt.Errorf("no field named %q was found under type TradingAccountWithTasks", field.Name)
		},
	}
	defer func() {
		if r := recover(); r != nil {
	...
	ctx = graphql.WithFieldContext(ctx, fc)
	if fc.Args, err = ec.field_Query_tradingAccountsWithTasks_args(ctx, field.ArgumentMap(ec.Variables)); err != nil {
		ec.Error(ctx, err)
		return
	}
	return fc, nil
	...
	for i, field := range fields {
		...
		case "tradingAccountsWithTasks":
			...
			innerFunc := func(ctx context.Context) (res graphql.Marshaler) {
				...
				res = ec._Query_tradingAccountsWithTasks(ctx, field)
				if res == graphql.Null {
					atomic.AddUint32(&invalids, 1)
				}
				return res
