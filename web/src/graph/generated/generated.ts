...
export type TaskHistoryFragmentFragment = { __typename?: 'TaskHistory', id: string, taskID: string, isSuccess: boolean, log: string, updatedAt: any, createdAt: any };
...
export type DeleteTradingAccountMutationVariables = Exact<{
  id: Scalars['ID']['input'];
}>;


export type DeleteTradingAccountMutation = { __typename?: 'Mutation', deleteTradingAccount: boolean };
...
export const DeleteTradingAccountDocument = {"kind":"Document","definitions":[{"kind":"OperationDefinition","operation":"mutation","name":{"kind":"Name","value":"DeleteTradingAccount"},"variableDefinitions":[{"kind":"VariableDefinition","variable":{"kind":"Variable","name":{"kind":"Name","value":"id"}},"type":{"kind":"NonNullType","type":{"kind":"NamedType","name":{"kind":"Name","value":"ID"}}}}],"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"deleteTradingAccount"},"arguments":[{"kind":"Argument","name":{"kind":"Name","value":"id"},"value":{"kind":"Variable","name":{"kind":"Name","value":"id"}}}]}]}}]} as unknown as DocumentNode<DeleteTradingAccountMutation, DeleteTradingAccountMutationVariables>;
