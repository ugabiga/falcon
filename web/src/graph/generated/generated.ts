...
export type GetTaskIndexQuery = { __typename?: 'Query', taskIndex?: { __typename?: 'TaskIndex', selectedTradingAccount?: { __typename?: 'TradingAccount', id: string, name: string, exchange: string, ip: string, identifier: string, tasks?: Array<{ __typename?: 'Task', id: string, currency: string, amount: number, cryptoCurrency: string, cron: string, type: string, nextExecutionTime?: any | null, isActive: boolean, tradingAccountID: string, params?: any | null }> | null } | null, tradingAccounts?: Array<{ __typename?: 'TradingAccount', id: string, name: string, exchange: string, ip: string, identifier: string, tasks?: Array<{ __typename?: 'Task', id: string, currency: string, amount: number, cryptoCurrency: string, cron: string, type: string, nextExecutionTime?: any | null, isActive: boolean, tradingAccountID: string }> | null }> | null } | null };
...
export type CreateTaskMutation = { __typename?: 'Mutation', createTask: { __typename?: 'Task', id: string, currency: string, amount: number, cryptoCurrency: string, cron: string, nextExecutionTime?: any | null, isActive: boolean } };
...
export type UpdateTaskMutation = { __typename?: 'Mutation', updateTask: { __typename?: 'Task', id: string, currency: string, amount: number, cryptoCurrency: string, cron: string, nextExecutionTime?: any | null, isActive: boolean } };
